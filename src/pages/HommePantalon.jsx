    ...
    return (
        <>
            ...
            <main>
                ...
                <h1>PANTALONS</h1>
                <Categories/>
                <SectionArticle genre="Homme" TabArticle={data.pantalonA}/>
                <SectionArticle genre="Homme" TabArticle={data.pantalonB}/>
                <SectionArticle genre="Homme" TabArticle={data.pantalonC}/>
            </main>
            <footer>
                <Footer/>
            </footer>
