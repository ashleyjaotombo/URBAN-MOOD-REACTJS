    ...
    return (
        <>
            ...
            <main>
                ...
                <SectionArticle genre="Femme" TabArticle={data.accessoireA}/>
                <SectionArticle genre="Femme" TabArticle={data.accessoireB}/>
                <SectionArticle genre="Femme" TabArticle={data.accessoireC}/>
            </main>
            <footer>
                <Footer/>
            </footer>
